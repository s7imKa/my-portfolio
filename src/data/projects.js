const projects = [
...

    {
        ...
        description:
            'Портал для перегляду інформації про персонажів Marvel з карточками та пошуком.',
        image: '/images/projects/marvel-project.png',
        techStack: ['React', 'Vite', 'Framer Motion', 'React Router'],
    },
    {
        id: 5,
        title: 'Food Project',
    ...
    },
    {
        ...
        description: 'Проект з інтеграцією мультимедіа та обробкою відео/аудіо.',
